...
import { Folder, FileText, CheckCircle, Clock, XCircle, Plus } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-olive-700">Visão geral do sistema PlanTrab</p>
      </div>
        ...
        {statCards.map((stat) => {
          ...
          return (
            ...
            >
              ...
              <div className="text-3xl font-bold text-military-900 mb-1">{stat.value}</div>
      ...
      <div className="bg-white rounded-lg border border-olive-200 p-6">
        <h2 className="text-xl font-semibold text-military-900 mb-4">Ações Rápidas</h2>
